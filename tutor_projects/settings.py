...
ALLOWED_HOSTS = os.getenv("DJANGO_ALLOWED_HOSTS", "34.77.110.157:8000,localhost").split(",")
...
CORS_ALLOWED_ORIGINS = os.getenv("CORS_ALLOWED_ORIGINS", "http://34.77.110.157:8000,https://34.77.110.157:8000").split(",")
