...
ALLOWED_HOSTS = os.getenv("DJANGO_ALLOWED_HOSTS", "34.79.160.113").split(',')
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_AUTHENTICATION_CLASSES": [
        ...
        # 'rest_framework.authentication.SessionAuthentication', # Якщо потрібна сесія для адмінки/браузера
    ],
...
FRONTEND_URL = os.getenv("FRONTEND_URL", "http://127.0.0.1:8000/api/user")
...
MAX_TEACHER_SUBJECTS = int(os.getenv("MAX_TEACHER_SUBJECTS", 2))
MAX_TEACHER_CATEGORIES = int(os.getenv("MAX_TEACHER_CATEGORIES", 2))
MAX_TEACHER_LANGUAGES = int(os.getenv("MAX_TEACHER_LANGUAGES", 3))
...
GOOGLE_SERVICE_ACCOUNT_FILE = os.path.join(
    BASE_DIR,
    "credentials",
    os.getenv("GOOGLE_SERVICE_ACCOUNT_FILE_NAME", "google-credentials.json"),
)
