...
class BaseUser(AbstractBaseUser, PermissionsMixin):
    ...
    role = models.CharField(
        _("Role"), max_length=10, choices=ROLES_CHOICES, null=True, blank=True
    )
...
class Teacher(models.Model):
    ...
    teaching_experience = models.PositiveIntegerField(
        _("Teaching experience (years)"), null=True, blank=True
    )
    ...
    lesson_price = models.DecimalField(
        _("Lesson price (UAH)"), max_digits=8, decimal_places=2, null=True, blank=True
    )
